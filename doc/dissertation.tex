...
% fixme: check this is at most 100 words
...
% fixme: need to decide on capitalisation conventions for oosh, bash and fish
...
\end{verbatim}
Note we have rudimentary types here, distinguishing between strings and integers.
...
effectiveness of my bandwidth optimisations versus a na\:ive implementation. I
